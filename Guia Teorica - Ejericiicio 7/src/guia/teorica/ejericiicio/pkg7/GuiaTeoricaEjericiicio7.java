 ...
 */
package guia.teorica.ejericiicio.pkg7;
 ...
 */
public class GuiaTeoricaEjericiicio7 {
...
“No existe un valor válido para tipo de bomba”
    ...
    public static void main(String[] args) {
        ...
        switch (tipoMotor){
            ...
            default: System.out.println("No existe un valor válido para tipo de bomba, vuelva a intentarlo.");
